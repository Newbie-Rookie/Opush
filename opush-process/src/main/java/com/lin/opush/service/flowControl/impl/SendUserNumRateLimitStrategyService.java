 ...
 * 根据发送用户数进行流量控制
 */
@LocalFlowControlStrategy(flowControlStrategy = FlowControlStrategy.SEND_USER_NUM_RATE_LIMIT)
public class SendUserNumRateLimitStrategyService implements FlowControlStrategyService {
    /**
     * 根据发送用户数进行流量控制
     * @param taskInfo         任务参数

package com.lin.opush.service.config;
...
import com.lin.opush.service.action.AfterParamCheckAction;
import com.lin.opush.service.action.AssembleParamAction;
import com.lin.opush.service.action.PreParamCheckAction;
import com.lin.opush.service.action.SendMqAction;
...
public class ExecutionChainConfig {
    ...
    public ExecutionController processController() {
        ...
        executionChainConfig.put(BusinessCode.COMMON_SEND.getCode(), commonSendTemplate());
